...
import (
	...
	"rocket-map-example/web/resources"
)
...
func run() error {
	files := map[string]string{
		"https://cdn.jsdelivr.net/gh/starfederation/datastar@v1.0.4/bundles/datastar-rocket.js":           resources.StaticDirectoryPath + "/datastar/datastar-rocket.js",
